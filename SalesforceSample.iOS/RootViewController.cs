...
namespace SalesforceSample.iOS
{
	public class AccountObject : SObject
	{
		...
		public string Phone
		{
			get { return GetOption ("Phone", string.Empty); }
			set { SetOption ("Phone", value); }
		}

		public string Industry
		{
			get { return GetOption ("Industry", string.Empty); }
			set { SetOption ("Industry", value); }
		}

		public string Website
		{
			get { return GetOption ("Website", string.Empty); }
			set { SetOption ("Website", value); }
		}

		public string AccountNumber
		{
			get { return GetOption ("AccountNumber", string.Empty); }
